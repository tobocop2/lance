...
fn cosine_fast_f64_dispatched(x: &[f64], x_norm: f32, y: &[f64]) -> f32 {
    #[cfg(target_arch = "x86_64")]
    {
        match *SIMD_SUPPORT {
            ...
            SimdSupport::Avx2 | SimdSupport::AvxFma => unsafe { f64_x86::cosine_fast_avx_fma(x, x_norm, y) },
...
fn cosine_fast_f32_dispatched(x: &[f32], x_norm: f32, other: &[f32]) -> f32 {
    #[cfg(target_arch = "x86_64")]
    {
        match *SIMD_SUPPORT {
            ...
            SimdSupport::Avx2 | SimdSupport::AvxFma => unsafe { f32_x86::cosine_fast_avx_fma(x, x_norm, other) },
